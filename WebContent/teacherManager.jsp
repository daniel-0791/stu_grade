...
<script type="text/javascript" src="mbjsmbstxy.js"></script>
    <div id="left" class="col-md-2 thumbnail">
        ...
        <div>
          <a  target="chaxun"><%= "欢迎你! " %>${name1}</a>
        </div>
        <div>
        
        <br>
        <img  src="${photo1}" width="70px" height="70px">
        </div>
        <ul class="nav nav-pills nav-stacked">
            <li><a href="student_grade_list" target="chaxun">成绩管理</a></li>
           
            <li><a  href="studentList" target="chaxun">学生列表</a></li>
            <li><a  href="gradeSort" target="chaxun">分数统计</a></li>
